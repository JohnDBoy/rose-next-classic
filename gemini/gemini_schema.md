<!-- 
IMPORTANT: GEMINI FILE SCHEMA
DO NOT MODIFY OR REMOVE THIS SECTION

Gemini, this file defines the standard structure of all `gemini_*.md` files.
You must follow this schema to maintain consistency, readability, and token efficiency.

END OF INSTRUCTION
-->

# Gemini File Schema Reference

This document describes the standard layout and sections for all `gemini_*.md` files.
